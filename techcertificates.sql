...
SELECT pg_catalog.setval('public.course_coursekey_seq', 27, true);
...
SELECT pg_catalog.setval('public.instructor_instructorkey_seq', 10, true);
...
SELECT pg_catalog.setval('public.person_personkey_seq', 402, true);
